...
it in the bridge, and blow the ship up after getting in to an escape pod.

You're running down the central corridor to the Weapons Arms and a 
...
nebhaq gur ubhfr, fur fvgr nebhaq gur ubhfr. The Gothon stops, tries 
...
You do a dice roll into the Weapon Armory, crouch and scan the room for
more Gothoms that might be hiding. It's dead quite too quite. You
stand up and run to the far side of the room and find the neutrom bomb
...
grab the neutrom bomb and run as fast as you can to the bridge where you
must place it in the right spot.

You burst onto the the Bridge with the netrom destruct bomb under your arm
...
pulled their weapons out uet, as they see the active bomb under your arm
...
there hands up and start to sweat. You inch backward to the door, open
it, and then carefully place the bomb on the floor pointing your
blaster ar it. You then jump back through the door, punch the close
...
look back and see your ship implode then expload like a bright star,
...
out into the void of space, then implodes as the hull ruptures, crashing
